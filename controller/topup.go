...
func EpayNotify(c *gin.Context) {
	...
	if verifyInfo.TradeStatus == epay.StatusTradeSuccess {
		...
		if topUp.Status == common.TopUpStatusPending {
			...
			// Calculate and record distribution commission
			service.CalculateAndRecordCommission(topUp.UserId, quotaToAdd, topUp.TradeNo, model.CommissionTypeChannelTopup)
